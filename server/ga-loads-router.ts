...
router.get("/_version", (_req: Request, res: Response) => {
  res.json({ ok: true, version: "2026-04-20-approval-checkin", hasDispatchNow: true, hasSopPage: true, hasOpsMonitor: true, hasParseDedup: true, hasOpsUI: true, hasSettlements: true, hasMarkDelivered: true, hasStatementsCron: true, hasTokenBackfill: true, hasDriverPhotos: true, hasGeofence: true, hasNominatim: true, hasPhotoTab: true, hasDispatchTrackingLink: true, hasPhotoApproval: true, hasDriverCheckin: true });
});
